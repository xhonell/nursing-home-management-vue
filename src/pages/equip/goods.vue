<template>
  <div class="app-container">
    ...
    >
      ...
      -->
      <el-table-column label="物资编号" align="center" width="80">
      ...
      <el-table-column label="物资入库时间" width="110px" align="center">
        <template slot-scope="{ row }">
          <span>{{ row.goodsStartDate | parseTime("{y}-{m}-{d}") }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="物资剩余数量">
          <el-input
            v-model="temp.goodsInDepot"
            placeholder="请填写物资剩余数量"
          />
        </el-form-item>
        <el-form-item label="物资供应商">
          <el-input
            v-model="temp.goodsProvider"
            placeholder="请填写物资供应商"
          />
        </el-form-item>
        <el-form-item label="物资入库时间">
          <el-input
            v-model="temp.goodsStartDate"
            type="date"
        ...
        <el-form-item label="物资分类">
          <el-select v-model="temp.classifyName" placeholder="请选择">
            <el-option
