<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="设备位置" min-width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.equipPosition }}</span>
        </template>
      </el-table-column>

      <el-table-column label="设备状态" width="110px" align="center">
        <template slot-scope="{row}">
          <span>{{ row.equipState }}</span>
        </template>
      </el-table-column>
      <el-table-column
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        -->
        <el-form-item label="设备编号" hidden>
          <el-input v-model="temp.equipId" />
        </el-form-item>
        <el-form-item label="设备名称" prop="equipName">
          <el-input v-model="temp.equipName" placeholder="请填写设备名称" />
        </el-form-item>
        <el-form-item label="设备位置">
          <el-input v-model="temp.equipPosition" placeholder="请填写设备位置" />
        </el-form-item>
        <el-form-item label="设备状态">
          <el-input v-model="temp.equipState" placeholder="请选择设备状态" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      deleteArticle(row.equipId).then(response => {
        this.$notify({
          title: '成功',
          message: response.msg,
          type: 'success'
